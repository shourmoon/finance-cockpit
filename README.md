...
- **One-salary coverage** — every applied top-up is recorded with a reason (a one-off shock, or a genuine recurring shortfall), and the dashboard keeps the running score: how many of the last twelve months the primary salary covered unaided, the current and best clean-month streak, the average monthly gap, and optionally how much of a second salary stayed in savings. A toggle switches between counting every top-up and counting only recurring shortfalls.
